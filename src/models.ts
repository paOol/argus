...
export function defaultModelDir(): string {
  if (process.env.ARGUS_MODEL_DIR) return process.env.ARGUS_MODEL_DIR;
 ...
 */
export async function resolveModel(model: string, options: ResolveModelOptions = {}): Promise<string> {
